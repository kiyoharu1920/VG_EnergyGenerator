  ...
  return (
    ...
    >
      <button
        data-testid={testid}
        onClick={onClick}
        className={`control-pressable focus-ring h-8 w-16 shrink-0 rounded-full border ${fontSizeClass} font-bold transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:scale-[0.92] ${rollId > 0 ? "control-result-confirm" : ""} ${controlBg}`}
  ...
  return (
    ...
    >
      <button
        ...
        className={`control-pressable focus-ring h-8 min-w-0 flex-1 ${controlButtonClass} rounded-lg border px-2 text-[12px] font-bold transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:scale-[0.97] ${controlBg}`}
      ...
      <div className={`${themeWrapperClass} shrink-0 flex items-center justify-center`}>
        <button
          ...
          className={`control-pressable focus-ring h-8 w-8 shrink-0 rounded-full border text-base font-bold transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:scale-[0.92] ${controlBg}`}
      ...
      <div className={`${skinWrapperClass} shrink-0 flex items-center justify-center`}>
        <button
          ...
          onClick={onCycleSkin}
          className={`control-pressable focus-ring h-8 w-16 shrink-0 rounded-full border text-[12px] font-bold transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-lg active:translate-y-0 active:scale-[0.92] ${controlBg}`}
